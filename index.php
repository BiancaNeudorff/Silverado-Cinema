    ...
    <div id='container'>
      ...
      <div id='header' class='row'>
          ...
          <div id='menu' class='col col-6'>
              ...
              <a href='#' onclick='loadPage("cinema")'>CINEMA</a>
              <a href='#' onclick='loadPage("movies")'>MOVIES</a>
      ...
      <div id='footer' class='row'>
        <hr>
        <div class='col col-1'></div>
        <div class='col col-5'>Silverado Cinema | 10 Blockbuster Road</div>
        <div class='col col-6' style='text-align:right'>Matt Hayward | S3537899</div>
      </div>
    </div>
    <script>
      $.ajaxSetup ({
